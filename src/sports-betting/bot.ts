    ...
    switch (cmd) {
      ...
      case 'rules':
        return [
          ...
          '   June 21: BET 1 ⏭️ NOT PLACED — Wheeler vs Peterson (SNB 7:20 PM ET). User did not place.',
          '              Wheeler 6-1, 2.01 ERA. Peterson 3-5, 5.91 ERA. Pick was valid but skipped.',
          '   June 22: No standard ML picks (rotation gap). 2 PROP/NRFI bets placed:',
          '              LEG 1 ✅ WON — Rasmussen Over 5.5 Ks (Rays vs Royals). K prop validated.',
          '              LEG 2 ❌ LOST — Astros-Blue Jays NRFI. First inning run scored despite elite starters.',
          ...
          '   June 25: BET 1 🔥 CONFIRMED — Phillies ML + Nationals TT under 3.5 (Sanchez 1.80 ERA, Duran 1.69 ERA ✅).',
          '              BET 2 🔥 CONFIRMED — Bryce Miller Over 5.5 Ks (Mariners vs Pirates, 10.03 K/9).',
          '              ⚠️ Pre-research BET 2 (Sale vs A\'s) VOIDED: Sale on 60-day IL (rib fracture June 18).',
          '              [RESULTS PENDING — user to confirm both scores.]',
          '   June 26: BET 1 🔥 CONFIRMED — Phillies ML + Mets TT under 3.5 (Wheeler 2.11 ERA, Duran 1.69 ERA ✅).',
          '              BET 2 🔥 CONFIRMED — K parlay: Misiorowski Over 5.5 Ks + Skenes Over 5.5 Ks.',
          '              ⚠️ Pre-research VOIDED: Yamamoto (June 28) & Cease (June 27) not pitching today.',
          '              [RESULTS PENDING — user to confirm both scores.]',
          '   June 27: ⏭️ NO BETS PLACED — research passes hit session limits, never finalized. User did not place.',
          '   June 28: ⏭️ NO BETS PLACED — thin slate (all aces off), verification pass hit session limit. User did not place.',
          '   July 4:  BET 1 🔥 CONFIRMED — Dodgers ML + Padres TT under 3.5 (Yamamoto 2.67 ERA, Tanner Scott 1.14 ✅).',
          '              BET 2 (line-dependent) — Sonny Gray Over 5.5 Ks + Red Sox ML @ Angels (MLB #1 K offense).',
          '              ⚠️ Gray K prop ONLY valid at 5.5 line; at 6.5 it is ~47% (skip). Confirm line day-of.',
          '              ⚠️ Fades: Skenes, Crochet (60-day IL), Misiorowski, Skubal (unconfirmed), Rodón (IL) all off/out.',
          ...
          '      LESSON #9: NRFI bets fail even with two elite starters. First-inning ERA ≠ season ERA.',
          '      A walk + single or error ends the bet regardless of the starter\'s overall dominance.',
          '      NRFI is high-variance — treat as supplementary only, never as a primary big-stake leg.',
          '      LESSON #10: Pre-research has an expiry. ALWAYS re-verify day-of — injuries change everything.',
          '      Sale rib fracture (June 18) voided entire BET 2 premise that was locked days earlier.',
          '      Never trust picks built on 3-5 day old data without a same-day injury/availability check.',
          '   ⏭️ June 21 BET 1: NOT PLACED — user did not place.',
          '      Wheeler (6-1, 2.01 ERA, 0.85 WHIP) vs Peterson (3-5, 5.91 ERA). Sunday Night Baseball 7:20 PM ET.',
          '      Pick was fully researched and valid. No result to log.',
          ...
          '📅 *June 22 — RESULTS:*',
          '   No standard ML SGP picks (rotation gap — all aces pitched June 20-21).',
          '   Pivoted to PROP + NRFI bets given rotation gap.',
          '   ✅ LEG 1 WON — Drew Rasmussen Over 5.5 Ks (Rays vs Royals, 6:40 PM ET)',
          '      Rasmussen 2026: 9.37 K/9, last 3 starts 29 Ks/21 IP. K prop is bullpen-independent.',
          '   ❌ LEG 2 LOST — Astros-Blue Jays NRFI (7:07 PM ET)',
          '      Hunter Brown (0.84 ERA) + Cease (2.71 ERA) — elite starters, but first-inning run scored.',
          '      LESSON #9: NRFI is high-variance. Season ERA ≠ first-inning ERA. Do not use as primary big stake.',
          '   ⚠️ ALL elite starters were unavailable June 22 (standard ML SGP screen):',
          ...
          '     - Hunter Brown (Astros, 0.84 ERA in 2 starts): used for NRFI, not ML SGP',
          '',
          ...
          '',
          '📅 *June 25 — PICKS CONFIRMED (2 bets, day-of research complete):*',
          '   ⚠️ CORRECTION: Pre-research BET 2 (Sale vs A\'s) was INVALID.',
          '   Chris Sale fractured left rib cage June 18 → 60-day IL (out until Aug 19). Braves NOT vs A\'s today.',
          '   BET 2 replaced with Bryce Miller K prop (Mariners vs Pirates) — found day-of.',
          '',
          '   🔥 BET 1 — HIGH CONFIDENCE: Phillies ML + Nationals TT under 3.5 (SGP, ~6:45 PM ET, Nationals Park)',
          '     Sanchez 9-3, 1.80 ERA (3rd MLB), 121 Ks. NL Pitcher of Month June. Phillies 11-5 in his starts.',
          '     Nationals starter: Cade Cavalli (3.98 ERA) — Irvin on IL with shoulder strain.',
          '     Phillies closer: Jhoan Duran 1.69 ERA, 19/20 saves ✅ — PASSES ≤2.50 easily.',
          '     Poisson λ=2.0 vs Sanchez → P(X≤3) = 85.7%. Phillies ML true prob: ~65%+.',
          '     3 independent sources confirm (NBC Sports, BetMGM, SI). PLACE at 1× standard unit.',
          '',
          '   🔥 BET 2 — HIGH CONFIDENCE: Bryce Miller Over 5.5 Ks (Mariners vs Pirates, ~6:40 PM ET)',
          '     Miller: 1.58 ERA (post-May return), 10.03 K/9, 30.5% K rate (career best).',
          '     Last 3 starts: 23 Ks in 19 IP → 7.7 Ks per start average. 5.5 line is his floor.',
          '     4 sources agree (Covers, VSiN, FanDuel Research, FantasyAlarm). True prob: ~72%+.',
          '     K prop = bullpen-independent. Decided before he leaves the mound. PLACE at 1× standard unit.',
          '     Place as SEPARATE bet from BET 1 — do NOT parlay (combined ~47% vs 65%+ each standalone).',
          '',
          '📅 *June 26 — PICKS CONFIRMED (2 bets, two independent research passes):*',
          '   ⚠️ PRE-RESEARCH CORRECTIONS (LESSON #10 — pre-research expires):',
          ...
          '     • Wheeler CONFIRMED June 26 @ Mets (road start, 7:10 ET) — this is the live pick.',
          '',
          '   🔥 BET 1 — Phillies ML + Mets TT under 3.5 (SGP, 7:10 PM ET, Citi Field). #1 ML both passes.',
          '     Wheeler 7-1, 2.11 ERA, 8.9 K/9. ≤2 runs in 9 of 11 starts. June 3-0, 1.82 ERA.',
          '     Mets offense weak: .227 AVG, .652 OPS, -47 run diff. Countering with rookie Zach Thornton (0-1, 8.31 ERA).',
          '     Phillies closer: Jhoan Duran 1.69 ERA, 19/20 saves ✅ — PASSES ≤2.50 bullpen check.',
          '     ⚠️ Wheeler on ROAD (home ERA 1.78, slightly worse away). Matchup compensates. True ML ~62-65%.',
          '     PLACE at 1× standard unit.',
          '',
          '   🔥 BET 2 — Two-ace K parlay: Misiorowski Over 5.5 Ks + Skenes Over 5.5 Ks. Bullpen-independent.',
          '     Misiorowski (MIL, home vs Cubs): 8-3, 1.45 ERA, 13.4 K/9 — MLB leader. 0.45 ERA since May 1.',
          '       ⚠️ Cubs low-K offense (24th) — STUFF play not matchup play, but 13.4 K/9 carries it. ~72%.',
          '     Skenes (PIT, home vs Reds): 2.85 ERA, 10.9 K/9. Reds whiff-heavy (5 regulars >27% K%) —',
          '       BEST K matchup on the slate. Home scoreless streak. ~75%.',
          '     ⚠️ Combined parlay ~54%. Each leg clears 60%+ as a SINGLE — split into 2 singles for higher hit rate.',
          '     Place SEPARATELY from BET 1. Do NOT combine BET 1 + BET 2.',
          '     LESSON: only ONE clean ML SGP existed today (Phillies). Brewers closer (Megill ~4.29/committee)',
          '     and Pirates (no closer, Bednar traded) both FAIL bullpen check → no 2nd ML SGP. K parlay fills BET 2.',
          '',
          '📅 *June 27–28 — NO BETS PLACED (documented for record):*',
          '   June 27: Both research passes hit the session limit and never returned usable matchups. No picks finalized.',
          '   June 28: Thin slate — Yamamoto/Skenes/Wheeler/Misiorowski/Cease all pitched other days; Crochet on IL.',
          '     Best angle was Hunter Brown (road, thin -124 ML) — did not clear the bar. Verification pass hit limit.',
          '     LESSON #11: Session limits can kill a research pass mid-flight. If day-of research does not complete,',
          '     deliver NOTHING rather than stale/partial analysis. A missed day beats an unverified bet.',
          '',
          '📅 *July 4 — PICKS (2 bets, two independent research passes; proxy blocked live lines — verify day-of):*',
          '   Confirmed FADES: Skenes (pitched Jul 1), Crochet (60-day IL), Misiorowski (not today),',
          '     Skubal (unconfirmed for the 4th), Rodón (IL Jul 3). Only elite arm active = Yamamoto.',
          '',
          '   🔥 BET 1 — Dodgers ML + Padres TT under 3.5 (SGP, Dodger Stadium). #1 both passes. HIGH confidence.',
          '     Yamamoto 8-5, 2.67 ERA, 0.89 WHIP, ~8.3 K/9 (home) vs Griffin Canning 1-7, 7.09 ERA.',
          '     Padres bottom-3 MLB: .218 AVG (last), ~.655 OPS (29th), 6-game losing streak, stars slumping.',
          '     Closer: Tanner Scott 1.14 ERA, 0.59 WHIP ✅ (committee w/ Diaz out, all <2.50).',
          '     Math: Padres TT under λ≈2.6 → P(X≤3)=73.6%. Dodgers ML true ~75%. SGP combined ~58-62%, +EV.',
          '     Do NOT play flat -280 ML — value is the SGP. PLACE at 1× unit.',
          '',
          '   BET 2 (LINE-DEPENDENT) — Sonny Gray Over 5.5 Ks + Red Sox ML (SGP @ Angels, night).',
          '     Gray 9-1, ~2.69 ERA, 24 Ks last 3 starts (8/start) vs Angels = MLB #1 K offense (~25% K rate).',
          '     Gray Over 5.5 Ks: λ≈6.5 → P(X≥6) ~63-67% ✅. Chapman 0.46 ERA closer ✅ backs Red Sox ML.',
          '     ⚠️ ONLY valid at 5.5 line. At 6.5, P(X≥7) ~47% → SKIP. Gray season K/9 only ~8.1 (form+matchup play).',
          '     ⚠️ Verify posted K line AND that Boston is favored before placing (proxy blocked live prices).',
          '',
          '📅 *July 7 — PICKS (two independent passes, dates double-confirmed per user request):*',
          '   DOUBLE-confirmed to pitch July 7: Misiorowski (2:15 ET @ STL, G1 DH), Skubal (6:40 ET vs A\'s).',
          '   Single-pass confirmed: Wheeler (@ Reds), deGrom (vs Angels), Skenes (vs Braves). FADE: Crochet (60-day IL).',
          '   KEY: books priced the elite arms\' K lines UP to where edge vanishes —',
          '     Misiorowski Over 7.5 (~43-52%), Skubal Over 8.5 (<50%), Wheeler Over 6.5 (~53%) all FAIL 60%.',
          '',
          '   FINAL DAY-OF CHECK RESULTS (this is the system working — cleared 1 risk, killed 1 play):',
          '   ✅ deGrom HEALTHY — the "neck" flag was STALE (March 2026 scratch, no July injury). Confirmed starting.',
          '      Game is ~11:05 PM ET (west-coast night game), not 8 ET. Angels = WORST K offense in MLB (~25%), banged up.',
          '   ❌ deGrom line is actually 7.5 (FanDuel O -104), NOT 6.5. He avgs ~6.8 K/start → Over 7.5 only ~50-52%.',
          '      → deGrom Over is a PASS at 7.5. LINE-SHOP: only a play if a book posts 6.5 (then Over 6.5 ~65%).',
          '   ❌ Reds TT under → PASS. Weather NEGATIVE (84-91F, small park, wind blowing OUT). Reds K-rate unconfirmed',
          '      (the "high-K" stat traced to Phillies PITCHING, not Reds hitting). Two strikes → drop it.',
          '   🎯 LONE SURVIVING PLAY — Phillies ML @ Reds (~7:10 ET). True ~64% vs -167 implied ~62.5% = small +EV.',
          '      Wheeler 2.36 ERA healthy + Duran 1.69 closer ✅ + Reds missing bats (Dunn/Myers/Hayes). Straight single.',
          '   LESSON #12: Day-of line verification is non-negotiable. A leg modeled at ~70% collapsed to ~51% once the',
          '     REAL posted line (7.5 not 6.5) was confirmed. Never compute probability on an assumed line — pull the actual number.',
          '',
          '📅 *July 10 — PICKS (two independent passes, dates double-confirmed; All-Star break starts after Jul 12):*',
          '   FADES: Hunter Greene (2nd start off IL, 21.60 ERA), Grayson Rodriguez (8.06 ERA),',
          '     Hunter Brown (passes DISAGREED — one rec\'d his K prop, other labeled stats IL-clouded/unconfirmed → cut).',
          '',
          '   🥇 PLAY 1 (straight single) — Chris Sale Over 5.5 Ks (Braves @ Cardinals, 8:15 ET). Best-corroborated arm.',
          '     Sale 9-6, 2.10 ERA, 10.9 K/9, 29% K-rate; 1.94 ERA last 13 starts. Date confirmed by 5 sources, healthy (All-Star).',
          '     Math: λ≈6.9 → P(≥6)=~68% at 5.5. ⚠️ At 6.5 drops to ~53% → PASS. Cardinals K% unconfirmed (no boost assumed).',
          '   🥈 PLAY 2 (straight single) — Astros ML @ Rangers (8:05 ET). True ~60% vs -143 implied ~58.8% = fair/small +EV.',
          '     Edge = Rangers throw Cal Quantrill (4-12, 6.04 ERA); Astros closer Josh Hader 0.59 ERA, 10/10 saves ✅.',
          '     ⚠️ Only ~60% (not higher) because Hunter Brown is volatile post-IL — bet leans on Quantrill being bad + Hader.',
          '   Both STRAIGHT singles, different games (independent). Sale 5.5 is the stronger; if only 6.5 exists, Sale = PASS.',
          '',
          '📅 *July 11 — PICKS (two independent passes; strikeout-prop day, NO qualifying ML):*',
          '   CROSS-CHECK CATCH: passes disagreed on Nationals offense — sourced pass showed WASHINGTON = TOP-5 offense',
          '     (.740 OPS, 5.46 R/G). Kills Yankees ML (not weak opp + Bednar closer 3.52-4.70 fails ≤2.50).',
          '     Phillies ML also out — Sanchez 2.62 vs Mize 2.64 duel, model leans Tigers. No ML qualifies today.',
          '',
          '   🥇 PLAY 1 (straight single) — Cam Schlittler Over 5.5 Ks (Yankees @ Nationals). Both passes confirmed.',
          '     2.01 ERA (2nd MLB), 0.93 WHIP, 10.4 K/9, ~6.9 K/start, 6+ Ks in last 7 road starts. Line 5.5 (FD -132).',
          '     Math: λ≈6.8 (discounted for WSH contact offense) → P(≥6)=~67%. ⚠️ At 6.5 (Athlon) drops to ~52% → 5.5 ONLY.',
          '   🥈 PLAY 2 (LINE-SHOP) — Joe Ryan Over Ks (Twins vs Angels). Angels = WORST K offense MLB (25% K).',
          '     10.5 K/9, fanned 11 Angels last meeting. ⚠️ Posted line 7.5 (-113) → only ~57% (avg 6.4 K/start). PASS at 7.5.',
          '     If a book posts 6.5 → ~70%, strong play. Shop the number.',
          '   PASS: Sanchez Over 6.5 (~56%, fair line no edge). One confident bet (Schlittler) beats forcing coin flips.',
          '',
          '📅 *July 13-15 — MLB ALL-STAR BREAK (no MLB games; ASG Jul 14). July 13 = dead day all sports.*',
          '',
          '📅 *July 15 — SOCCER: World Cup SEMIFINAL England vs Argentina (3 PM ET Atlanta). Two passes.*',
          '   FIRST soccer card. Winner is a COIN FLIP (Eng 35% / Draw 34% / Arg 31% vig-removed) → NOT a high-prob bet.',
          '   Both teams conceded in EVERY knockout game; tournament ~2.9 gpg. Eng missing Quansah(susp)+Henderson(out); Arg clean.',
          '   🥇 PLAY 1 — Under 3.5 total goals (90-min) ~70%. λ_reg≈2.7 → P(≤3)=~70%. Loses only on 4+ in regulation;',
          '     ET goals EXCLUDED (2 of Arg\'s knockouts went to ET at low reg scores) = structural protection.',
          '   🥈 PLAY 2 — Double Chance England-or-Draw ~69%. Loses only if Argentina wins in 90. Hedges the coin-flip.',
          '   Alts: BTTS Yes ~64% (sharpest form read); Over 1.5 ~80% (near-lock, tiny payout ~-450).',
          '   LESSON #13 (SOCCER): knockout winner markets are coin-flips — edge lives in totals/double-chance, NOT 1X2.',
          '     Use REGULATION-only goals for O/U (ET excluded). Soccer high-prob legs (~70%) pay small — grind value, not big scores.',
          '   PRICE UPDATE (day-of): Under 3.5 came back -450 (implied 82% vs my ~70-78% → -EV TRAP), DC -275 (implied 73% vs ~69% → -EV).',
          '     BOTH high-prob legs were OVER-JUICED → PASS. Real edge = Over 2.5 at +130 (implied 43.5% vs true ~53% = +EV ~+18% ROI).',
          '   LESSON #14: A high WIN-PROBABILITY leg is NOT the same as a good BET. Always convert price→implied prob and compare to',
          '     true prob. "Safe" legs at heavy juice (-450) are the casino-edge trap. +EV can live on a ~53% side if the price is generous.',
          '     But +EV ≠ high hit-rate — stake coin-flip-plus +EV bets SMALL (1-2%), not big. Two different questions: probability vs value.',
          '',
          '📅 *July 19 (evening) — NO BET. Only upcoming game = Dodgers @ Yankees G2 7:20 ET, a BULLPEN GAME (both aces',
          '     Yamamoto/Schlittler pitched G1 of a rain doubleheader). No starter → no K prop; ML near pick-em (-120) = -EV. PASS.*',
          '   The good arms (Sonny Gray 11-1 2.54, McClanahan 2.83, Mize 2.79) all threw in AFTERNOON getaway games (done by 6 ET).',
          '   LESSON #15: SUNDAYS are getaway days — quality starters pitch in DAY games (12-4 ET). For Sunday action, research by',
          '     ~noon ET, not evening. And rain doubleheaders turn the nightcap into a bullpen game (no startable prop) — auto-pass.',
          '',
          '🎯 *BETTING SYSTEM — 7-LEVEL FRAMEWORK (apply to EVERY card before suggesting legs):*',
          '   Source: user-provided video (Tyson / Secured Pick). Internalized as standing method.',
          '   50/50 RULE: half of winning is psychology + bankroll + discipline; half is the actual picks.',
          '   BANKROLL: never bet >10% of bankroll in one day. UNIT = 2-3% of bankroll (up to 5% high tolerance).',
          '     2-3 bets/day ideal (5 max). Never bet emotional; detach from a bad 2-3 day stretch; take red days off.',
          '   STRAIGHT BETS > PARLAYS: consistent 1x-2x singles beat chasing big parlays. Default to singles;',
          '     only use SGP when legs are positively correlated AND each leg still clears 60% on its own.',
          '   LINE SHOPPING (+EV): compare line across books; half-points decide wins. Compare TRUE prob vs',
          '     IMPLIED prob from the price — only bet when true > implied (+EV).',
          '   LINE TIMING: get on OVERS / favorites EARLY (public money inflates them by game time);',
          '     WAIT LATE on UNDERS (they inflate too → better value near first pitch).',
          '   MLB FOCUS FACTORS: hitter-vs-pitcher matchups, player/pitcher SPLITS (home/road, vs L/R), WEATHER',
          '     (wind out = more runs → fade unders; wind in = favor unders). Always check park factor.',
          '   BUSINESS MINDSET: journal every bet, track units, judge results over WEEKS/MONTHS not single days.',
          '',
