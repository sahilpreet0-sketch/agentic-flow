    ...
    switch (cmd) {
      ...
      case 'rules':
        return [
          ...
          '',
          '   🥇 PLAY 1 (straight single) — deGrom Over 6.5 Ks (Rangers vs Angels, 8:05 ET). True ~70%.',
          '     10.7 K/9 vs Angels top-8 K offense, no innings cap. VERIFY line ≤6.5 + not scratched (neck/knee flag).',
          '   🥈 PLAY 2 (straight single) — Phillies ML @ Reds (~7:10 ET). True ~64% vs -165 implied ~62% = +EV.',
          '     Wheeler 2.36 ERA + Duran 1.69 closer ✅. Only passing closer on the slate.',
          '   ⏸️ Reds TT under 3.5 ~56% — GAB hitter park. WAIT for game-time value + check wind. Lean PASS.',
          '   Delivered as STRAIGHT singles (not parlayed) per 7-level system — parlaying the two drops combined to ~45%.',
          '',
